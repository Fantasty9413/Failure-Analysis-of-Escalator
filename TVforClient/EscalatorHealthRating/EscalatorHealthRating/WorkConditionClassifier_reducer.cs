...
{
    public class WorkConditionClassifier_reducer : WorkConditionClassifier
    {
        ...
        public WorkConditionClassifier_reducer() : base("reducer") 
        {
            Tv_Size = 16;
            _tv = new MWNumericArray(1, Tv_Size);
             modelsuffixname = "reducer";
            _modelsuffixname = new MWCharArray(modelsuffixname);
        }
        public override int GetWorkConditionLabel(double[] tv_channel_2)      // 获取预测工况（结果以标签形式展示）
        {
