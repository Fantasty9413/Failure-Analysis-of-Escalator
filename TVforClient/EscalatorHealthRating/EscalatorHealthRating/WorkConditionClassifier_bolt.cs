...
{
    public class WorkConditionClassifier_bolt : WorkConditionClassifier
    {
        ...
        public WorkConditionClassifier_bolt() : base("bolt") 
        {
            Tv_Size = 16;
        ...
        public override int GetWorkConditionLabel(double[] tv_channel_5)      // 获取预测工况（结果以标签形式展示）
        {
